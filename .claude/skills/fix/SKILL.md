...
allowed-tools: Read, Grep, Glob, Edit, Write, Bash(pnpm:*), Bash(git status:*), Bash(git diff:*), Bash(git add:*), Bash(git commit:*), Bash(git log:*), Bash(git rev-parse:*), Bash(git show:*), AskUserQuestion
---
